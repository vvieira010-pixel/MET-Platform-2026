import{r as h,j as t}from"./vendor-react-D7Rhsbrn.js";import{c as T}from"./callAI-D6NJV3tp.js";import{R as k,a as I,b as E,L as j,c as W,d as C,e as A}from"./index-aQ27qe9F.js";import{S as P,W as m}from"./writing-CQ9oZDHT.js";const z=[{id:"reading",label:"Reading & Grammar",color:"var(--section-reading)"},{id:"listening",label:"Listening",color:"var(--section-listening)"},{id:"speaking",label:"Speaking",color:"var(--section-speaking)"},{id:"writing",label:"Writing",color:"var(--section-writing)"}];function b(s){if(s==="reading"){const e=[];return e.push({part:"Part 1 — Grammar",questions:k.questions,data:k}),I.passages.forEach((a,r)=>{e.push({part:`Part 2 — ${a.title}`,questions:a.questions,data:{passage:a.text,title:a.title}})}),E.textSets.forEach((a,r)=>{e.push({part:`Part 3 — ${a.title}`,questions:a.questions,data:{texts:a.texts,title:a.title}})}),e}if(s==="listening"){const e=[];return e.push({part:"Part 1 — Short Conversations",questions:j.questions,data:j}),W.conversations.forEach((a,r)=>{e.push({part:`Part 2 — ${a.title}`,questions:a.questions,data:{audio:a.audio,title:a.title}})}),C.talks.forEach((a,r)=>{e.push({part:`Part 3 — ${a.title}`,questions:a.questions,data:{audio:a.audio,title:a.title}})}),e}if(s==="speaking")return P.map(e=>({part:`Task ${e.id} — ${e.label.replace(/^Task \d+ — /,"")}`,questions:[e],data:e}));if(s==="writing"){const e=[];return e.push({part:m.task1.label,questions:m.task1.questions.map(a=>({...a,instruction:m.task1.instructions})),data:m.task1}),e.push({part:m.task2.label,questions:[{id:"w4",prompt:m.task2.prompt,instruction:m.task2.instructions,rows:m.task2.rows}],data:m.task2}),e}return[]}function R(s){return s.text?s.text:s.prompt?s.prompt:s.id?.startsWith("w")&&(s.prompt||s.text)||""}function _(s,e,a){const r=s==="reading"||s==="listening"?A(e.type,e.level):"—",n=e.answer!==void 0?String.fromCharCode(65+e.answer):"—",o=e.options?.[e.answer]||"—";return[`You are a MET assessment expert. Analyze this ${s} test question for a teacher to discuss in class.`,"","## Question Metadata",`- ID: ${e.id}`,e.type?`- Type: ${e.type}`:null,e.level?`- Level: ${e.level}`:null,r!=="—"?`- Points: ${r}`:null,e.options?`- Correct answer: ${n}. ${o}`:null,"",e.options?`## Options
...
`)}function S(){return t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"24px 0",color:"var(--text-muted)"},children:[t.jsx("span",{className:"spinner"}),t.jsx("span",{children:"Generating evaluation..."})]})}function G({type:s,level:e}){const a={grammar:"var(--type-grammar)",main_idea:"var(--type-main-idea)",detail:"var(--purple)",inference:"var(--error)"},r={b1:"var(--level-b1)",b2:"var(--level-b2)"};return t.jsxs("span",{style:{display:"inline-flex",gap:4,alignItems:"center"},children:[s&&t.jsx("span",{style:{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.04em",padding:"1px 7px",borderRadius:99,background:`${a[s]||"#888"}1a`,color:a[s]||"#888",border:`1px solid ${a[s]||"#888"}33`},children:s}),e&&t.jsx("span",{style:{fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.04em",padding:"1px 7px",borderRadius:99,background:`${r[e]||"#888"}1a`,color:r[e]||"#888",border:`1px solid ${r[e]||"#888"}33`},children:e})]})}function D(s){if(!s)return null;const a=(typeof s=="string"?s:s.text||s.content?.[0]?.text||"").split(`
`).filter(o=>o.trim()),r=[];let n=null;for(const o of a)/^\*\*/.test(o)||/^\d+\./.test(o)||/^###/.test(o)?(n&&r.push(n),n={heading:o.replace(/^\*+|\*+$/g,"").replace(/^###\s*/,"").trim(),body:[]}):n?n.body.push(o):r.push({heading:"",body:[o]});return n&&r.push(n),t.jsx("div",{style:{lineHeight:1.7,fontSize:"var(--text-sm)"},children:r.map((o,f)=>t.jsxs("div",{style:{marginBottom:12},children:[o.heading&&t.jsx("h4",{style:{fontSize:"var(--text-sm)",fontWeight:700,margin:"0 0 4px 0",color:"var(--text)"},children:o.heading}),o.body.map((p,x)=>p.startsWith("|")&&p.endsWith("|")?t.jsx("code",{style:{display:"block",fontSize:11,whiteSpace:"pre",overflow:"auto",padding:"2px 0"},children:p},x):t.jsx("p",{style:{margin:"2px 0"},children:p},x))]},f))})}function K(){const[s,e]=h.useState("reading"),[a,r]=h.useState(null),[n,o]=h.useState({}),[f,p]=h.useState(null),x=h.useRef(null),y=b(s);h.useEffect(()=>{r(null),o({})},[s]),h.useEffect(()=>{x.current&&x.current.scrollIntoView({behavior:"smooth",block:"start"})},[n]);const w=h.useCallback(async i=>{if(r(i.id),n[i.id])return;p(i.id);let d="";if(s==="reading")for(const l of b("reading")){const g=l.questions.find(u=>u.id===i.id);g&&l.data?.passage?d=`## Context Passage
> ${l.data.passage}`:g&&l.data?.texts&&(d=`## Context Texts
...
- Part: ${i.part}`),s==="writing"&&(d=i.instruction?`- Instructions: ${i.instruction}`:"");const c=_(s,i,d),v="You are a MET (Michigan English Test) assessment specialist and teacher trainer. Your task is to analyze individual test questions for a teacher who will discuss them in class. Be specific, reference the actual content of the question, and avoid generic statements. Write in clear, professional English. Format the response with markdown section headers (no code blocks — just plain markdown). Include a distractor analysis table where applicable. Keep it under 500 words.";try{const l=await T(c,{system:v,temperature:.4,max_tokens:2048}),g=l?.content?.[0]?.text||l?.text||"";o(u=>({...u,[i.id]:g}))}catch(l){o(g=>({...g,[i.id]:`⚠️ Evaluation failed: ${l.message}`}))}p(null)},[s,n]),$=y.reduce((i,d)=>i+d.questions.length,0),N=Object.keys(n).length;return t.jsxs("div",{className:"mte-page",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("div",{className:"mte-header",children:[t.jsx("h1",{children:"Mock Test Question Evaluator"}),t.jsx("p",{children:"Select a question to get AI-powered analysis for classroom discussion"})]}),t.jsx("div",{className:"mte-section-tabs",children:z.map(i=>t.jsx("button",{className:`mte-section-tab${s===i.id?" mte-section-tab--active":""}`,onClick:()=>e(i.id),children:i.label},i.id))}),t.jsxs("div",{className:"mte-layout",children:[t.jsxs("div",{className:"mte-questions-panel",children:[t.jsxs("div",{className:"mte-panel-header",children:[t.jsxs("span",{children:["Questions (",$,")"]}),t.jsxs("span",{className:"mte-progress",children:[N," evaluated"]})]}),y.map((i,d)=>t.jsxs("div",{className:"mte-part-group",children:[t.jsx("div",{className:"mte-part-header",children:i.part}),i.questions.map(c=>t.jsxs("div",{className:`mte-question-row${a===c.id?" mte-question-row--selected":""}`,onClick:()=>w(c),role:"button",tabIndex:0,onKeyDown:v=>(v.key==="Enter"||v.key===" ")&&(v.preventDefault(),w(c)),children:[t.jsx("div",{className:"mte-question-id",children:c.id}),t.jsxs("div",{className:"mte-question-body",children:[t.jsx("div",{className:"mte-question-text",children:R(c)}),t.jsx("div",{className:"mte-question-meta",children:t.jsx(G,{type:c.type,level:c.level})})]})]},c.id))]},d))]}),t.jsxs("div",{className:"mte-eval-panel",ref:x,children:[!a&&t.jsxs("div",{className:"mte-eval-empty",children:[t.jsx("div",{className:"mte-eval-empty-icon",children:"🔍"}),t.jsx("div",{children:"Select a question to see AI evaluation"})]}),a&&f===a&&t.jsx("div",{className:"mte-eval-loading",children:t.jsx(S,{})}),a&&f!==a&&n[a]&&t.jsxs("div",{className:"mte-eval-content",children:[t.jsxs("div",{style:{marginBottom:12,display:"flex",justifyContent:"space-between",alignItems:"center"},children:[t.jsx("h3",{style:{margin:0,fontSize:"var(--text-base)",fontWeight:700},children:a}),t.jsx("span",{style:{fontSize:10,color:"var(--text-muted)",opacity:.6},children:"AI · MET Specialist"})]}),D(n[a])]}),a&&f!==a&&!n[a]&&t.jsx("div",{className:"mte-eval-loading",children:t.jsx(S,{})})]})]})]})}export{K as default};
