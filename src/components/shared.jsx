/**
 * shared.jsx — MET Proficiency Platform Design System
...
export const GRADIENTS = {
  TEAL_NAVY: 'linear-gradient(120deg, var(--primary) 0%, var(--text) 100%)',
};
...
/* ─── FORM FIELD (canonical: ui/FormField.jsx) ─────────────── */
export { FormField } from './ui/FormField.jsx';
