...
export const Icon = {
  ...
  circle:   (p) => <SvgIcon {...p}><circle cx="12" cy="12" r="10"/></SvgIcon>,
  ...
  headset:    (p) => <SvgIcon {...p}><path d="M3 18v-6a9 9 0 0118 0v6"/><path d="M21 19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2h3v5z"/><path d="M3 19a2 2 0 002 2h1a2 2 0 002-2v-3a2 2 0 00-2-2H3v5z"/></SvgIcon>,
