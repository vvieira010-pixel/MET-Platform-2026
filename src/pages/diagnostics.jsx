          ...
          {filtered.map(dx => {
            ...
            return (
              <Card key={dx.id} className="square-card">
                ...
                <div className="text-sm" style={{ fontWeight: 600, textAlign: 'center', marginTop: 8 }}>{student?.name || 'Unknown student'}</div>
                ...
                <div className="flex-col items-center" style={{ gap: 4 }}>
                  ...
                  {totalCount > 0 && <span className="card-row-meta text-xs">{approvedCount}/{totalCount} approved</span>}
                </div>
