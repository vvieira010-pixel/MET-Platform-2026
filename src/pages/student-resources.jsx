                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 4 }}>
                    ...
                    <span style={{
                      ...
                      background: r.type === 'video' ? 'var(--warning-bg)' : r.type === 'article' ? 'var(--info-bg)' : 'var(--ink-light)',
                      color: r.type === 'video' ? 'var(--warning-text)' : r.type === 'article' ? 'var(--info)' : 'var(--ink-muted)',
                    }}>
                      {tm.label}
                    </span>
                  </div>
